...
const Login = () => {
  ...
  return (
    <div>
      <div className=" h-screen flex justify-center items-center animate__animated animate__jackInTheBox"
      >
        ...
        <div className="hero">
          ...
          <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-white">
            ...
            {loginError && <p className="text-red-700 m-4">{loginError}</p>}
            {loginSuccess && (
              <p className="text-green-700 m-4">{loginSuccess}</p>
            )}
          </div>
        </div>
      </div>
